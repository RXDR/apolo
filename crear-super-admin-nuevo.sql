...
INSERT INTO public.usuarios (
    ...
    gen_random_uuid(),
    'a919f64f-cd3f-47aa-be09-c4b6e65a1505',
    'Cédula',
    '1234567890',
    'Administrador',
    'Sistema',
    ...
    '3001234567',
    'Dirección Principal',
    (SELECT id FROM public.ciudades WHERE nombre = 'Bogotá' LIMIT 1),
    'Bogotá',
    '1990-01-01',
    'Masculino',
    'Soltero',
...
INSERT INTO public.usuario_perfil (
    ...
    (SELECT id FROM public.usuarios WHERE auth_user_id = 'a919f64f-cd3f-47aa-be09-c4b6e65a1505'),
    (SELECT id FROM public.perfiles WHERE nombre = 'Super Admin'),
    true,
    NOW(),
    true
...
WHERE u.auth_user_id = 'a919f64f-cd3f-47aa-be09-c4b6e65a1505'
