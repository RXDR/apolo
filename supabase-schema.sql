...
CREATE TABLE IF NOT EXISTS public.usuarios (
    ...
    -- Autenticación (vinculado con auth.users de Supabase)
    ...
    -- Constraints
    CONSTRAINT chk_genero CHECK (genero IN ('Masculino', 'Femenino', 'Otro', 'Género')),
